...
- **907 test verdi** nei sette progetti che girano senza Docker (Core 530,
  Headless 205, Persistence.Unit 80, Golden 68, Property 12, Architecture 6,
...
- **15 voci aperte** — P1 1 · P2 1 · P3 5 · P4 1 · P5 7 — più **14** in
...
| **`LiveDbObjectBodyResolver`, 764 righe**, apre due connessioni per clic e fino a 16 query. **La metà a buon mercato è fatta il 2026-08-20:** lo switch ha ora i case per `TableType` e `Schema`, quindi quei due pannelli non sono più vuoti — `TableTypeUdtReaderTests.The_diff_viewer_has_a_body_for_a_table_type_and_for_a_schema` li fissa dal vivo, con sonda di mutazione caduta. Resta la riscrittura: due connessioni e sedici query per un clic, ed è il prerequisito della virtualizzazione dei pannelli diff | 2026-08-14 | L | `Providers.LiveDb/ObjectBody/LiveDbObjectBodyResolver.cs:33`, `:35-49` (lo switch), `:277-321` (il corpo tabella) |
