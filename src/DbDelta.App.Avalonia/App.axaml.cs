...
public partial class App : Application
{
    ...
    public override void OnFrameworkInitializationCompleted()
    {
        if (ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
        {
            ...
            Core.Abstractions.ICredentialStore credentials = Persistence.Credentials.CredentialStoreFactory.Create();
            Core.Abstractions.IConnectionStore connectionStore = Persistence.Json.JsonConnectionStore.CreateDefault();
