...
> **Status:** Stable — [v1.2.0](https://github.com/GitBakko/db-delta/releases/tag/v1.2.0) is the current release; [v1.0.1](https://github.com/GitBakko/db-delta/releases/tag/v1.0.1) was the first final one.
